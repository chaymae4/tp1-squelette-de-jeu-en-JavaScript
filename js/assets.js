...
const assetsToLoadURLs = {
    appstore: { url:("../assets/images/app-store.png" )},
    playstore: { url:("../assets/images/play-store.png" )},
    seringue: { url:("../assets/images/seringue.png" )},
    medecins: { url:("../assets/images/medecins.jpg" )},
    popup: {
      url:
